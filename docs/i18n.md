...
Translation files are located in the `src/shared/assets/locales` directory:
...
```json
{
    ...
    "homepage": {
        "whyLearn": { "title": "...", "subtitle": "...", "card1": { "title": "...", "description": "..." } },
        "ourApproach": { "title": "...", "subtitle": "...", "item1": { "title": "...", "description": "..." } },
        "whatLearn": { "title": "...", "subtitle": "...", "item1": { "title": "..." } },
        "cta": { "title": "...", "button": "..." }
    },
...
1. **HomePage/index.jsx**: Uses translations for all main content sections.
2. **MainLearn.jsx**: Uses translations for navigation items and lesson names.
3. **Lession.jsx**: Uses translations for feedback messages.
4. **useLessionHook.js**: Uses translations for button values.

## Adding New Languages

To add a new language:

1. Create a new translation file in the `src/shared/assets/locales` directory (e.g., `en.json`)
